...
public class SetGetDeclaredFieldBased2 extends SetGetGenerator {

	public SetGetDeclaredFieldBased2(Class<?> setClass, Class<?> getClass, String setParamName, String getParamName) {
		super();
